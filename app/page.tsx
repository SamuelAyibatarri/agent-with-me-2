...
import PropertyCard from "@/app/components/PopertyCard";
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                  <svg width="45.396" height="60" viewBox="0 0 45.396 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8">
                    <g>
              ...
              <p className="text-gray-400">
                Simplifying the way you find your next home, securely and confidently.
              </p>
            </div>
            <div>
