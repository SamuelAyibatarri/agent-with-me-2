      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl sm:text-2xl font-bold text-white">Agent with me</span>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/properties">
              <Button variant="ghost" className="text-white hover:border hover:bg-transparent hover:text-white">
                Properties
              </Button>
            </Link>
            ...
            <Link href="/auth/register">
              <Button className="bg-white text-black hover:text-white">Sign Up Free</Button>
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-2 border-t border-white/10 pt-4">
            ...
            <Link href="/auth/register" onClick={() => setMobileMenuOpen(false)}>
              <Button className="w-full bg-white text-black hover:text-white">Sign Up Free</Button>
            </Link>
          </div>
        )}
      </div>
